...
int main(int _argc, char **_argv)
{
    ...
    char findstudent_data[20] = "find-student-by-id";
    char findcourse_data[20] = "find-course-by-code";
    char theenrollment_data[20] = "create-enrollment";
    char theenrollments_data[20] = "print-enrollments";
    char slash[20] = "---";
    char year[20] = "2020";
    for (i = 0; i < 100; i++)
    {
